		...
		switch (curCharacter)
		{
			...
			case 'bf-annie':
				...
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Pico NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'Pico Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Pico Idle Dance', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Pico Idle Dance', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
				...
				animation.addByPrefix('singUPmiss', 'Pico Idle Dance', 24);
				animation.addByPrefix('singDOWNmiss', 'Pico Idle Dance', 24);

				addOffset('idle');
				addOffset("singUP", -1, 40);
				addOffset("singRIGHT", 4, 48);
				addOffset("singLEFT", 0, 49);
				addOffset("singDOWN", -208, -35);
