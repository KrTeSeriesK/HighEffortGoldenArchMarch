	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'annieBackgroud': 
					...
					var streetBehind:FlxSprite = new FlxSprite(-40, 50).loadGraphic(Paths.image('philly/behindRoad','week3'));
					add(streetBehind);

					phillyTrain = new FlxSprite(2000, 360).loadGraphic(Paths.image('philly/Cars','week3'));
					if(FlxG.save.data.distractions){
						add(phillyTrain);
					}
			...
			case 'philly': 
					...
					var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('philly/air', 'week3'));
					bg.scrollFactor.set(0.1, 0.1);
					add(bg);

					var city:FlxSprite = new FlxSprite(-10, 70).loadGraphic(Paths.image('philly/buildings', 'week3'));
					city.scrollFactor.set(0.3, 0.3);
					city.setGraphicSize(Std.int(city.width * 0.85));
					city.updateHitbox();
					add(city);
					...
					for (i in 0...5)
					{
							var light:FlxSprite = new FlxSprite(city.x, 70).loadGraphic(Paths.image('philly/light' + i, 'week3'));
							light.scrollFactor.set(0.3, 0.3);
							light.visible = false;
							light.setGraphicSize(Std.int(light.width * 0.85));
							light.updateHitbox();
					...
					var street:FlxSprite = new FlxSprite(-40, streetBehind.y).loadGraphic(Paths.image('philly/road','week3'));
					add(street);
					}
			case 'limo':
			{
		...
		healthBar.createFilledBar(0xFF00FF90, 0xFFFF2043);
		// healthBar
		add(healthBar);
